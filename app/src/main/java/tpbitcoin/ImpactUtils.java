...
public class ImpactUtils {
    ...
    public static long expectedMiningTime(long hashrate, BigInteger difficultyAsInteger){
        double averageHashCount = 1.0 / calculateMiningProbability(difficultyAsInteger);
        return (long) (averageHashCount / hashrate);
    }
    ...
    /**
     * Compute the total energy consumption of the network assuming each miner has the same hashrate, and consumes the same power
    ...
    public static double calculateEnergyConsumptionLast24h(double c, double p) {
